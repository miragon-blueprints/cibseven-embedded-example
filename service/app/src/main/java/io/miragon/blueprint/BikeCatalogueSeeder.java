 ...
 * Bruno / Playwright scenarios always find their ids. Idempotent — {@code save} upserts by id.
 *
 * <p>{@code BIKE-OOS} is seeded deliberately: it is the dealer's out-of-stock bike, so selecting it
 * from the UI drives the bike-unavailable → alternative-selection scenario end to end. Availability
 * itself is decided by the dealer, not stored here.
 *
